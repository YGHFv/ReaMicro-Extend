...
.highlight,.code-input,.search-overlay{position:absolute;inset:0;margin:0;border:0;outline:0;padding:14px 14px calc(var(--editor-bottom, 88px) + 12px) 14px;font-family:"Cascadia Mono","JetBrains Mono",monospace;font-size:14px;line-height:1.62;white-space:pre;word-break:normal;overflow:auto;tab-size:2}
...
function syncEditor(){syncLines(true);syncSearchHits();syncScroll();scheduleHighlight(120)}
